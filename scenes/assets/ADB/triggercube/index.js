...
export default () => {
  ...
  useActivate(() => {
    ...
    loader.load( `${baseUrl}number4.glb`, function ( gltf ) {
    ...
    overlay.innerHTML = "Cool, how many cores do you want?";
    document.body.appendChild( overlay );
    setTimeout(() => {
    const box = document.getElementById('CoresQuestion');
