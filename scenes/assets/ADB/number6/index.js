...
export default () => {
  ...
  let targetSpec = null;
  useActivate(() => {
    console.log('activate button 6');

    var dbname="";

      function post() {
                //  var x = document.getElementById("mySelect").value;
                  var url = "http://localhost:3000/createAutonomousDatabase?compartmentId=ocid1.compartment.oc1..aaaaaaaakqwqnhktr7tdq3mqahejxaotzg4ejyce64yjtsmyqvzc7af4dq6a&cpuCoreCount=6";
                //  var data = { "name": x };
                  fetch(url, {
                      method: 'POST', // or 'PUT'
    ...
    overlay.style.outline = 'none';
    overlay.style.zIndex = '999';
    overlay.innerHTML = "Your 6 cores autonomous database '"+dbname+"' has been succesfully provisioned.";
    //alert('name:'+dbnameg);
    document.body.appendChild( overlay );
