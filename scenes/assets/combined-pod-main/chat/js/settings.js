import { registerIoEventHandler, unregisterIoEventHandler } from '../../../../../src/components/general/io-handler';
...
const chatWidgetSettings = {
    URI: 'oda-cfcc2c5ccc044fd795d9e25f8772165e-da4.data.digitalassistant.oci.oraclecloud.com',                               // ODA URI, only the hostname part should be passed, without the https://
    ...
    channelId: '1386fc82-56c4-429c-a521-8298eb8485ba',                   // Channel ID, available in channel settings in ODA UI, optional if client auth enabled
    userId: defaultPlayerName,                         // User ID, optional field to personalize user experience
